//INICIO función realizarPagoInternet
function realizarPagoInternet() {
  var pagoInternet = document.getElementById('pagoInternet').value;
...
//FIN función realizarPagoInternet
...
var input = document.getElementById('npeInternet');
